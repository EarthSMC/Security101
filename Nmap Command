...
| Spoofed Source IP      | sudo nmap -S SPOOFED_IP 10.10.17.9 <IP target> |
| Spoofed MAC Address    | --spoof-mac SPOOFED_MAC |
| Decoy Scan    | nmap -D DECOY_IP,ME 10.10.17.9 |
| Idle (Zombie) Scan    | sudo nmap -sI ZOMBIE_IP 10.10.17.9 |
